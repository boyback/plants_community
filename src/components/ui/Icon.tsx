...
const paths: Record<IconName, string> = {
  ...
  "thumbs-up": "M7 10v11M3 11v9a1 1 0 0 0 1 1h3V10H4a1 1 0 0 0-1 1Zm4-1 5-7a2 2 0 0 1 3.6 1.2L18 8h3a2 2 0 0 1 2 2.3l-1.2 8A2 2 0 0 1 19.8 20H7V9Z",
  ...
  alert: "M12 8v6M12 18h.01M10.3 3.9 2.4 17.5A2 2 0 0 0 4.1 20h15.8a2 2 0 0 0 1.7-2.5L13.7 3.9a2 2 0 0 0-3.4 0Z",
  star: "m12 2 3.1 6.3 6.9 1-5 4.9 1.2 6.9L12 18l-6.2 3.1L7 14.2 2 9.3l6.9-1L12 2Z",
  moon: 'M21 13.8A8.5 8.5 0 1 1 10.2 3a6.5 6.5 0 0 0 10.8 10.8Z',
...
}: {name: IconName;className?: string;size?: number;strokeWidth?: number;fill?: 'none' | 'currentColor';}) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
      ...
      className={cn(cx(styles.r_bb0c4bfc, styles.r_012fbd12), className)}
      aria-hidden>
