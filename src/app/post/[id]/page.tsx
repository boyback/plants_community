            ...
            <div className='mb-6 flex items-center gap-3 border-b border-leaf-100 pb-4'>
              ...
              <div className='min-w-0 flex-1'>
                ...
                <div className='text-[11px] text-leaf-700/70'>
                  ...
                  <I18nText k='detail.post.views' fallback='阅读' />
                </div>
              </div>
              {/* 作者本人可以编辑 */}
        ...
        <aside className='hidden lg:block'>
          <div className='sticky top-[60px] max-h-[calc(100vh-72px)] space-y-4 overflow-y-auto'>
              ...
              <div className='mt-3 grid grid-cols-4 border-t border-leaf-100 pt-3 text-center text-xs'>
                <div>
                  ...
                  <div className='text-leaf-700/70'>
                    <I18nText k='detail.post.postsLabel' fallback='帖子' />
                  </div>
                </div>
                <div>
                  <div className='font-semibold text-ink-800'>
                    {formatNumber(post.author.pointsBalance)}
                  </div>
                  <div className='text-leaf-700/70'>积分</div>
                </div>
                <div>
                  <div className='font-semibold text-ink-800'>
                    {formatNumber(post.author.followers)}
                  </div>
                  <div className='text-leaf-700/70'>
                    <I18nText k='detail.post.followersLabel' fallback='粉丝' />
                  </div>
                </div>
                <div>
                  <div className='font-semibold text-ink-800'>
                    {formatNumber(post.author.following)}
                  </div>
                  <div className='text-leaf-700/70'>
                    <I18nText k='detail.post.followingLabel' fallback='关注' />
                  </div>
                </div>
              </div>
            ...
            <div className='card p-4'>
              <div className='mb-3 text-sm font-semibold text-ink-800'>
                📖 <I18nText k='detail.post.related' fallback='推荐帖子' />
              </div>
